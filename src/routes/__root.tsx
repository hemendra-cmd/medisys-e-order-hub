    ...
    <div className="flex min-h-screen items-center justify-center bg-background px-4">
      <div className="max-w-md text-center">
        ...
        <div className="mt-6 flex flex-wrap justify-center gap-2">
          ...
          <a href="/" className="inline-flex items-center justify-center rounded-md border px-4 py-2 text-sm hover:bg-accent">
            Go home
          </a>
        </div>
      </div>
...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Medisys — B2B Ordering for Labs & Diagnostics" },
      {
        name: "description",
        content:
      ...
      { property: "og:title", content: "Medisys — B2B Ordering for Labs & Diagnostics" },
      { property: "og:description", content: "Trusted supplier for clinics and diagnostic labs across India." },
